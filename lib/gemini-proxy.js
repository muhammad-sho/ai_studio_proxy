function createGeminiProxy({
  ...
  // than maintaining a potentially stale local cache. A single configured key is used
  // because discovery does not consume model inference quota or affect load balancing.
