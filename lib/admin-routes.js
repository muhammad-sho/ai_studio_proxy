function createRequestHandler({
  crypto, db, prep, log, json, securityHeaders, readBody,
  ...
  passwordDigest, passwordValid, clearLoginFailures, hasAdmin, createSession, destroySession,
  hashValue, invalidateSecretMaskCache,
