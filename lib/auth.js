function createAuth({ prep, crypto, trustProxy, sessionTtlMs, cookieSession, cookieCsrf, log }) {
  ...
  function resolveClientKey(request) {
    ...
    const supplied = request.headers["x-goog-api-key"] || query.get("key") || "";
  ...
  return {
    ...
    passwordDigest, passwordValid, createSession, destroySession, pruneExpiredSessions,
  };
}
